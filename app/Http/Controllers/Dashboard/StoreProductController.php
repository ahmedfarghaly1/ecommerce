...
class StoreProductController extends Controller
{
      ...
      public function index(Products $product) 
      {
          ...
          $storeproduct = $product->paginate(8);
      
          return view('Dashboardadmin.Store.index', compact('storeproduct'));
      }
      ...
      public function search(Request $request) 
      {
          ...
          return view('Dashboardadmin.Store.search_index', compact('product'));
      }
      ...
      public function deleteid(Request $request) 
      {
       ...
       {
           return view('Dashboardadmin.Store.add_product');
       }
      ...
      public function edit($id)
       {
          ...
          return view('Dashboardadmin.Store.edit', compact('data'));
