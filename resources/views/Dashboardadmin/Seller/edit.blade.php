...
@endif
   ...
   <form  dir="rtl" role="form" method="POST" action="{{ url('/adminpanel/product/update/').'/'.$data->id }}" enctype="multipart/form-data">
...
<td style="width:50%;" >
 ...
 <tr>
                        ...
                        <div class="divwits">
                            <input  type="text" name="countities"   value="{{$data->countities}}"
