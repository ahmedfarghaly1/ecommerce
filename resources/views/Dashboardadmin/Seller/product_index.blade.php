...
@section('content')
 ...
 <section class="content-header" style="background-color: " >
      <form  role="form" method="POST" action="{{url('/adminpanel/product/search')}}" enctype="multipart/form-data">
    ...
    {{csrf_field()}}
      ...
      <ol class="breadcrumb" style="margin-left:85%;">
        ...
        <li class="active"><a href="{{url('/adminpanel/product/create')}}"> أضافة منتج
      </ol>
