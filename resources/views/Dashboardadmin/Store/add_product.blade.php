...
@endif
   ...
   <form  dir="rtl" role="form" method="POST" action="{{ url('/adminpanel/StoreProduct/stor') }}" enctype="multipart/form-data">
...
<td style="width:50%;" >
 ...
 <tr>
                        ...
                        <div class="divwits">
                            <input style="width:50%;float:left"  type="text" name="size" 
                           ...
                           >
                            ...
                            <select style="width:50%;" class="form-control " placeholder=" الحجم "
                            name="size" id="size">
