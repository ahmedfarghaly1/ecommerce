    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image" >
          <img src="admin/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image" style="margin-left:360%;">
        </div>
        <div class="pull-left info">
         <h4> <p style=" color:;margin-top:-6%;font: normal normal normal 17px/1 FontAwesome;margin-left:-15%;">Alexander Pierce
      ...
      <!-- search form -->
       <!-- search form -->
       <form action="#" method="get" class="sidebar-form" dir="rtl">
